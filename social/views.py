...
class IndexView(CreateView,ListView):
    ...
    def get_queryset(self):
        ...
        blockedprofiles_id=[pr.user.id for pr in blocked_profiles]
        print(blockedprofiles_id)
        qs=Posts.objects.all().exclude(user__id__in=blockedprofiles_id).order_by("-created_date")
        return qs
